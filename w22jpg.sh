...
w22jpg() { 
wf="${HOME}/logs/w"; 
w="$(basename $(ls -1 $wf/w|fzf||return 2))"||return 2; 
ww="${w/.*/}"; 
####
...
convert -gravity center -background "#f5f5f5" -bordercolor "#f5f5f5" -border "588" pango:"$(cat ${wf}/log/${ww}.xml)" ${wf}/img/${ww}.jpg; 
####
